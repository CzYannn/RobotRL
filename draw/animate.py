...
case_name = 'noncoop' # circle_case rand_case
...
def get_agent_traj(info_file, traj_file):
    ...
    return agents_info, traj_list, step_num_list
...
agents_info, traj_list, step_num_list = get_agent_traj(info_file, traj_file)
...
plot_episode(agents_info, traj_list, step_num_list, plot_save_dir = plot_save_dir,
